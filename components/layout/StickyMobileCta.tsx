...
/**
 * Floating circular CTAs on mobile: WhatsApp logo + phone logo only.
 */
    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 p-3 sm:p-4 md:hidden">
      <div className="pointer-events-auto ml-auto flex w-fit flex-col items-end gap-3">
        <a
          ...
          data-no-underline=""
          className="grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white no-underline shadow-[0_10px_28px_rgb(37_211_102/0.45)] ring-2 ring-white transition-transform active:scale-95"
        >
          <WhatsAppLogo />
        ...
        <a
          ...
          data-no-underline=""
          className="grid h-14 w-14 place-items-center rounded-full bg-brand-800 text-white no-underline shadow-[0_10px_28px_rgb(15_31_51/0.35)] ring-2 ring-white transition-transform active:scale-95"
        >
          <PhoneLogo />
